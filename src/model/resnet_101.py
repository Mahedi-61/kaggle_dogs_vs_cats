...
def ResNet101(include_top = False,
    ...
    # Arguments
        include_top : if true get full model. if false get model without top
        input_shape : input dim. default (224, 224, 3) atleast 197 
    ...
    eps = 1.1e-5
    # Handle Dimension Ordering for tensorflow only
    # For theano backend see change bn_axis = 1 and shape = (3, 224, 224)
    global bn_axis
    bn_axis = 3
    ...
    # The method below works because...
    # pre-trained weights are stored in layers but not in the model
